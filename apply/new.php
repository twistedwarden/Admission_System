...
$requirements = getRequirementsByType(APPLICANT_NEW);
...
<section class="py-12 header-gradient text-white rounded-xl mb-12">
    <div class="container mx-auto px-4 text-center">
        <h1 class="text-4xl font-bold mb-6">New Student Application</h1>
        <p class="text-xl max-w-3xl mx-auto">
            Complete the form below to apply as a new student. Make sure to provide accurate information.
        </p>
    </div>
</section>
...
<section class="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-8 mb-12 animate-on-scroll">
    ...
    <div class="mb-8">
        ...
        <form action="new.php" method="post" id="application-form">
            ...
            <div class="mt-8 mb-8">
                ...
                <p class="text-gray-700 mb-6">
                    Choose the academic program you wish to apply for.
                </p>
...
<section class="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-8 mb-12">
    ...
    <div class="space-y-6">
        <div class="flex items-start space-x-4">
            ...
            <div>
                ...
                <p class="text-gray-700">
                    Fill out the application form with accurate personal details and select your desired program.
                </p>
            </div>
        </div>
        ...
        <div class="flex items-start space-x-4">
            ...
            <div>
                ...
                <p class="text-gray-700">
                    After submitting your application, you will be directed to upload all required documents.
                </p>
            </div>
        </div>
        ...
        <div class="flex items-start space-x-4">
            ...
            <div>
                ...
                <p class="text-gray-700">
                    Pay the non-refundable application fee of PHP <?= ADMISSION_FEE ?> to process your application.
                </p>
            </div>
        </div>
        ...
        <div class="flex items-start space-x-4">
            ...
            <div>
                <h3 class="text-xl font-semibold text-dark-purple mb-2">Application Review</h3>
                <p class="text-gray-700">
                    Our admissions team will review your application and documents. This process typically takes 2-3 weeks.
                </p>
            </div>
        </div>
        ...
        <div class="flex items-start space-x-4">
            ...
            <div>
                <h3 class="text-xl font-semibold text-dark-purple mb-2">Decision Notification</h3>
                <p class="text-gray-700">
                    You will be notified of the admission decision via email. You can also check your application status online.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="mt-8 p-4 bg-gray-50 rounded-lg">
        <p class="text-sm text-gray-600">
            <strong>Note:</strong> Incomplete applications or those with missing documents may delay the review process. 
            Ensure all information is accurate and all required documents are submitted promptly.
        </p>
    </div>
</section>
